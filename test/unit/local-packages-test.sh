...
[[ ${#packages[@]} == 6 ]]
[[ ${packages[*]} == "omarchy-settings-dev omarchy-dev omarchy-nvim openai-codex-bin claude-code hermes-agent" ]]
...
printf '%s\n' 'pkgname = fixture' 'depend = nodejs>=22' 'depend = glibc' 'depend = omarchy-settings-dev' > "$work/metadata/.PKGINFO"
